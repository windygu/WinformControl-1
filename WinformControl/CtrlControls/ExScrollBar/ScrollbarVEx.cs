...
/*
     ...
     * 版本号：  V1.0.0.0 
     * 创建人：  wangyunpeng
     * 创建时间： 2020/10/9 11:48:25 
     * 描述    :
     * =====================================================================
     * 修改时间：2020/10/9 11:48:25 
     * 修改人  ： wangyunpeng
     * 版本号  ： V1.0.0.0 
     * 描述    ：
*/
...
namespace CtrlControls.ExScrollBar
{
    ...
    [DefaultEvent("Scroll")]
    public class ScrollbarVEx : ScrollbarEx
    {
        /// <summary>
        /// The mo large change
        /// </summary>
        ...
        /// The thumb color
        /// </summary>
        private Color thumbColor = Color.FromArgb(102, 180, 228);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollbarVEx"/> class.
        /// </summary>
        public ScrollbarVEx()
        {
            InitializeComponent();
