...
/*
     ...
     * 文件名：  ScrollbarExComponent 
     * 版本号：  V1.0.0.0 
     * 创建人：  wangyunpeng
     * 创建时间： 2020/10/9 11:34:02 
     * 描述    :
     * =====================================================================
     * 修改时间：2020/10/9 11:34:02 
     * 修改人  ： wangyunpeng
     * 版本号  ： V1.0.0.0 
     * 描述    ：
*/
...
namespace CtrlControls.ExScrollBar
{
    ...
    public class ScrollbarExComponent : Component, IExtenderProvider
    {
        public ScrollbarExComponent()
        {

        }

        public ScrollbarExComponent(IContainer container)
        {
            container.Add(this);
        }
        ...
        public void SetUserCustomScrollbar(Control control, bool blnUserCustomScrollbar)
        {
            ...
            else if (control is ComboBox)
            {
                ...
                cb.DataSourceChanged += Lb_DataSourceChanged;
                cb.SelectedIndexChanged += Lb_SelectedIndexChanged;
            }
        ...
        private Dictionary<Control, ScrollbarVEx> m_lstVCache = new Dictionary<Control, ScrollbarVEx>();
        private Dictionary<Control, ScrollbarHEx> m_lstHCache = new Dictionary<Control, ScrollbarHEx>();
